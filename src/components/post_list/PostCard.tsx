...
const PostCard = ({ post }: Props) => {
  return (
    <Link href={post.url}>
      <li className="flex h-full flex-col gap-3 overflow-hidden rounded-md border shadow-md transition hover:shadow-xl bg-white">
        ...
        <div className="flex flex-1 flex-col justify-between p-4 pt-1">
          <div>
            ...
            <h2 className="my-1 text-lg font-bold sm:text-xl md:text-lg">
              {post.title}
            </h2>
